...
namespace Steamworks.Data
{
	...
	internal partial struct gameserveritem_t
	{
		...
		internal readonly string GameDirUTF8() => Steamworks.Utility.Utf8NoBom.GetString( GameDir, 0, System.Array.IndexOf<byte>( GameDir, 0 ) );
		[MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] // byte[] m_szGameDir
		internal byte[] GameDir; // m_szGameDir char [32]
		internal readonly string MapUTF8() => Steamworks.Utility.Utf8NoBom.GetString( Map, 0, System.Array.IndexOf<byte>( Map, 0 ) );
		[MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] // byte[] m_szMap
		internal byte[] Map; // m_szMap char [32]
		internal readonly string GameDescriptionUTF8() => Steamworks.Utility.Utf8NoBom.GetString( GameDescription, 0, System.Array.IndexOf<byte>( GameDescription, 0 ) );
		...
		internal readonly string ServerNameUTF8() => Steamworks.Utility.Utf8NoBom.GetString( ServerName, 0, System.Array.IndexOf<byte>( ServerName, 0 ) );
		[MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)] // byte[] m_szServerName
		internal byte[] ServerName; // m_szServerName char [64]
		internal readonly string GameTagsUTF8() => Steamworks.Utility.Utf8NoBom.GetString( GameTags, 0, System.Array.IndexOf<byte>( GameTags, 0 ) );
	...
	internal partial struct SteamDatagramHostedAddress
	{
		...
		internal readonly string DataUTF8() => Steamworks.Utility.Utf8NoBom.GetString( Data, 0, System.Array.IndexOf<byte>( Data, 0 ) );
	...
	internal struct SteamDatagramGameCoordinatorServerLogin
	{
		...
		internal readonly string AppDataUTF8() => Steamworks.Utility.Utf8NoBom.GetString( AppData, 0, System.Array.IndexOf<byte>( AppData, 0 ) );
